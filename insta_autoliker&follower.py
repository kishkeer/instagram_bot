...
for current_hashtag in CONFIGS['HASHTAGS']:
    ...
    while current_hashtag_likes < CONFIGS['TOTAL_LIKES_PER_HASHTAG']:
     ...
     likeButton = driver.find_element(  By.XPATH, "/html/body/div[4]/div[2]/div/article/div[2]/section[1]/span[1]/button"  )
     likeButton.click()
     time.sleep(2)

     follower=driver.find_element(By.XPATH,"/html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[2]/button").click()
     time.sleep(2)
     ...
     WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.CLASS_NAME, 'coreSpriteRightPaginationArrow' )))
